document.addEventListener("DOMContentLoaded", async () => {
  ...
  async function transform() {
    try {
      xmlData = await loadXMLDoc("../xml/application-sports.xml");
      const xslDoc = await loadXMLDoc("../xsl/application-sports.xsl");
  ...
  applicationListSection.addEventListener("click", (e) => {
    ...
    const applications = xmlData.getElementsByTagName("sports");
    let matchedApp = null;
