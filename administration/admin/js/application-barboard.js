document.addEventListener("DOMContentLoaded", async () => {
  ...
  async function transform() {
    try {
      xmlData = await loadXMLDoc("../xml/application-barboard.xml");
      const xslDoc = await loadXMLDoc("../xsl/application-barboard.xsl");
  ...
  applicationListSection.addEventListener("click", (e) => {
    ...
    const applications = xmlData.getElementsByTagName("bar_and_board");
    let matchedApp = null;
