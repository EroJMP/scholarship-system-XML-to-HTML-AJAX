document.addEventListener("DOMContentLoaded", async () => {
  ...
  async function transform() {
    try {
      xmlData = await loadXMLDoc("../xml/application-private.xml");
      const xslDoc = await loadXMLDoc("../xsl/application-private.xsl");
  ...
  applicationListSection.addEventListener("click", (e) => {
    ...
    const applications = xmlData.getElementsByTagName("private");
    let matchedApp = null;
