document.addEventListener("DOMContentLoaded", async () => {
  ...
  async function transform() {
    try {
      xmlData = await loadXMLDoc("../xml/application-chipin.xml");
      const xslDoc = await loadXMLDoc("../xsl/application-chipin.xsl");
  ...
  applicationListSection.addEventListener("click", (e) => {
    ...
    const applications = xmlData.getElementsByTagName("chip_in");
    let matchedApp = null;
