document.addEventListener("DOMContentLoaded", async () => {
  ...
  async function transform() {
    try {
      xmlData = await loadXMLDoc("../xml/application-academic.xml");
      const xslDoc = await loadXMLDoc("../xsl/application-academic.xsl");
  ...
  applicationListSection.addEventListener("click", (e) => {
    ...
    const applications = xmlData.getElementsByTagName("academic");
    let matchedApp = null;
