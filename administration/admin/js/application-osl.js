document.addEventListener("DOMContentLoaded", async () => {
  ...
  async function transform() {
    try {
      xmlData = await loadXMLDoc("../xml/application-osl.xml");
      const xslDoc = await loadXMLDoc("../xsl/application-osl.xsl");
  ...
  applicationListSection.addEventListener("click", (e) => {
    ...
    const applications = xmlData.getElementsByTagName("out_of_school_learners");
    let matchedApp = null;
