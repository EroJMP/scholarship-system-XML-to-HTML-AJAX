...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    ...
    <h2 class="section-title d-flex justify-content-between align-items-center fw-bold fs-2">
        Financial Assistance for Bar and Board Licensure Applications
      ...
      <table id="scholarshipTable" class="display">
        <thead>
          <tr>
            ...
            <th>Category</th>
            <th>Licensure Exam to Take</th>
            <th>Date of Bar Exam</th>
        ...
        <tbody>
          <xsl:for-each select="applications/application[@category='bar_and_board']/bar_and_board">
            <tr>
              ...
              <td><xsl:value-of select="college_school_information/licensure_exam_to_take"/></td>
              <td><xsl:value-of select="college_school_information/date_of_bar_exam"/></td>
