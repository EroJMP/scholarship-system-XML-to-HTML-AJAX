...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    ...
    <h2 class="section-title d-flex justify-content-between align-items-center fw-bold fs-2">
        Incentives for College Honor Graduates Applications
    ...
    <div class="bg-white p-4 rounded shadow-lg w-100 h-100">
      <table id="scholarshipTable" class="display">
        ...
        <tbody>
          <xsl:for-each select="applications/application[@category='college_honor_graduates']/college_honor_graduates">
            <tr>
              ...
              <td><xsl:value-of select="graduates_of_baccalaureate_courses/academic_honors"/></td>
